...
void test_add_works_correctly() {
/* Optionally name the test */
  SET_TEST_NAME("test_add_works_correctly()");
...
void test_subtract_works_correctly() {
  SET_TEST_NAME("test_subtract_works_correctly()");
  TEST_CASE(subtract(3, 2) == 1, "subtract(3, 2) did not return 1");
  TEST_CASE(subtract(4, -8) == 12, "subtract(4, -8) did not return 12");
}

void test_multiply_works_correctly() {
  SET_TEST_NAME("test_multiply_works_correctly()");
  TEST_CASE(multiply(3, 4) == 12, "multiply(3, 4) did not return 12");
  TEST_CASE(multiply(10, -6) == -60, "multiply(10, -6) did not return -60");
}

void test_divide_works_correctly() {
  SET_TEST_NAME("test_divide_works_correctly()");
